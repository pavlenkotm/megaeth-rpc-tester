...
class HistoricalDataStore:
    ...
    def get_data(self, endpoint: Optional[str] = None,
...
class HistoricalComparator:
    ...
    def compare_with_baseline(self, current_results: Dict[str, Dict[str, Any]],
        ...
        for endpoint, methods in current_results.items():
            ...
            for method, current_stats in methods.items():
                ...
                latency_change = (
                    ...
                    if baseline_avg_latency > 0 else 0
                )
    ...
    def get_trends(self, endpoint: str, method: str,
        ...
        for endpoint, methods in comparisons.items():
            ...
            for method, comparison in methods.items():
                ...
                if status != 'no_baseline':
                    lines.append(f"  Baseline Latency: {comparison['baseline_avg_latency_ms']:.2f}ms")
                    ...
                    lines.append(f"  Baseline Success Rate: {comparison['baseline_success_rate']:.2f}%")
                    lines.append(f"  Current Success Rate: {comparison['current_success_rate']:.2f}%")
